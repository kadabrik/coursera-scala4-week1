...
object WikipediaRanking {
  ...
  implicit def bool2int(a: Boolean): Int = if (a) 1 else 0

  val langs = List(
    "JavaScript", "Java", "PHP", "Python", "C#", "C++", "Ruby", "CSS",
    "Objective-C", "Perl", "Scala", "Haskell", "MATLAB", "Clojure", "Groovy")

//  val conf: SparkConf = new SparkConf().setAppName("Wikipedia").setMaster("spark://ec2-35-166-140-243.us-west-2.compute.amazonaws.com:7077")
